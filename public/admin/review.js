...
(() => {
  ...
  const style = document.createElement('link'); style.rel = 'stylesheet'; style.href = '/admin/review.css?v=20260831-1'; document.head.append(style); const logoStyle = document.createElement('link'); logoStyle.rel = 'stylesheet'; logoStyle.href = '/admin/logo-settings.css?v=20260908-1'; document.head.append(logoStyle); install(); window.fetchPendingCount = loadReview; window.loadAdminSettings = loadAllSettings; window.addEventListener('admin:authenticated', loadReview); setTimeout(() => { if (token()) loadReview(); }, 400);
})();
