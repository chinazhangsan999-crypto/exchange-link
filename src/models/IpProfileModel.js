...
const PROFILE_COLUMNS = `profile.lookup_status AS ip_lookup_status,
  ...
  profile.special_purpose_zh AS ip_special_purpose_zh,
  ...
  profile.crawler_operator_zh AS ip_crawler_operator_zh,
  profile.crawler_type AS ip_crawler_type,
  profile.crawler_type_zh AS ip_crawler_type_zh,
  profile.is_private_relay AS ip_is_private_relay,
  profile.private_relay_region AS ip_private_relay_region,
  profile.private_relay_region_zh AS ip_private_relay_region_zh,
...
async function initializeIpProfileTable() {
  ...
  const additions = {
    network_type_zh: 'TEXT', network_type_confidence: 'TEXT', asn_org_zh: 'TEXT', isp_zh: 'TEXT',
    special_purpose: 'TEXT', special_purpose_zh: 'TEXT', is_fullbogon: 'INTEGER', verified_crawler: 'INTEGER',
    crawler_operator: 'TEXT', crawler_operator_zh: 'TEXT', crawler_type: 'TEXT', crawler_type_zh: 'TEXT',
    is_private_relay: 'INTEGER', private_relay_region: 'TEXT', private_relay_region_zh: 'TEXT',
...
async function saveResolved(ipKey, result, sourceVersion = '') {
  return run(`UPDATE ip_profiles SET
      ...
      asn = ?, asn_org = ?, asn_org_zh = ?, isp = ?, isp_zh = ?,
      is_hosting = ?, is_mobile = ?, is_proxy = ?, is_vpn = ?, is_tor = ?, is_anycast = ?,
      special_purpose = ?, special_purpose_zh = ?, is_fullbogon = ?, verified_crawler = ?, crawler_operator = ?, crawler_operator_zh = ?, crawler_type = ?, crawler_type_zh = ?,
      is_private_relay = ?, private_relay_region = ?, private_relay_region_zh = ?, confidence = ?, confidence_zh = ?, profile_json = ?,
    ...
    String(result.isp_zh || '').slice(0, 200) || null,
